...
enum {
    MP_QSTR_ntptime_dot_py = MP_QSTRnumber_of,
    MP_QSTR_NTP_DELTA,
    MP_QSTR_host,
    MP_QSTR_settime,
    MP_QSTR__bang_I,
    ...
    MP_QSTR_humidity,
    MP_QSTR_temperature,
    MP_QSTR_ssd1306_dot_py,
    MP_QSTR_currentBoard,
    MP_QSTR_esp8266,
    MP_QSTR_pyboard,
...
const qstr_pool_t mp_qstr_frozen_const_pool = {
    ...
    200, // used entries
    {
        ...
        (const byte*)"\x02\xcf\x0a" "ssd1306.py",
        (const byte*)"\xd6\x0b\x0c" "currentBoard",
        (const byte*)"\xa9\x95\x07" "esp8266",
        (const byte*)"\x56\x96\x07" "pyboard",
        ...
        (const byte*)"\xe5\x0e\x07" "SSD1306",
        (const byte*)"\xe2\x81\x0b" "SSD1306_I2C",
        (const byte*)"\x10\x57\x0b" "SSD1306_SPI",
        ...
        (const byte*)"\x99\x6d\x02" "dx",
        (const byte*)"\x98\x6d\x02" "dy",
        (const byte*)"\x70\xe5\x06" "string",
        ...
        (const byte*)"\x39\x8d\x06" "MASTER",
        (const byte*)"\x2b\x4c\x04" "high",
        (const byte*)"\x31\x3f\x03" "low",
...
STATIC const byte bytecode_data_ntptime__lt_module_gt__settime[97] = {
    0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0f,
    MP_QSTR_settime & 0xff, MP_QSTR_settime >> 8,
    MP_QSTR_ntptime_dot_py & 0xff, MP_QSTR_ntptime_dot_py >> 8,
    0x81, 0x1d, 0x26, 0x26, 0x26, 0x28, 0x36, 0x2d, 0x00, 0x00, 0xff,
...
STATIC const mp_obj_int_t const_obj_ntptime__lt_module_gt__0 = {{&mp_type_int}, {.neg=0, .fixed_dig=1, .alloc=2, .len=2, .dig=(uint16_t[]){0xc200,0xbc17}}};
...
// frozen bytecode for file ssd1306.py, scope ssd1306__lt_module_gt__SSD1306___init__
STATIC const byte bytecode_data_ssd1306__lt_module_gt__SSD1306___init__[112] = {
    0x0a, 0x00, 0x00, 0x04, 0x00, 0x00, 0x10,
    MP_QSTR___init__ & 0xff, MP_QSTR___init__ >> 8,
    MP_QSTR_ssd1306_dot_py & 0xff, MP_QSTR_ssd1306_dot_py >> 8,
    0x81, 0x22, 0x25, 0x25, 0x25, 0x2a, 0x32, 0x3e, 0x27, 0x00, 0x00, 0xff,
    0xb1, 
    0xb0, 
    ...
    0x1d, MP_QSTR_height & 0xff, MP_QSTR_height >> 8,
    0x1c, MP_QSTR_framebuf & 0xff, MP_QSTR_framebuf >> 8,
    0x1d, MP_QSTR_MVLSB & 0xff, MP_QSTR_MVLSB >> 8,
    0x66, 0x04, 
    0xb0, 
    0x26, MP_QSTR_framebuf & 0xff, MP_QSTR_framebuf >> 8,
    0xb0, 
    0x1e, MP_QSTR_poweron & 0xff, MP_QSTR_poweron >> 8,
    0x66, 0x00, 
    0x32, 
    0xb0, 
...
STATIC const mp_rom_obj_t const_table_data_ssd1306__lt_module_gt__SSD1306___init__[4] = {
    MP_ROM_QSTR(MP_QSTR_self),
    MP_ROM_QSTR(MP_QSTR_width),
    MP_ROM_QSTR(MP_QSTR_height),
    MP_ROM_QSTR(MP_QSTR_external_vcc),
};
STATIC const mp_raw_code_t raw_code_ssd1306__lt_module_gt__SSD1306___init__ = {
    .kind = MP_CODE_BYTECODE,
    .scope_flags = 0x00,
    .n_pos_args = 4,
    .data.u_byte = {
        .bytecode = bytecode_data_ssd1306__lt_module_gt__SSD1306___init__,
        .const_table = (mp_uint_t*)const_table_data_ssd1306__lt_module_gt__SSD1306___init__,
        #if MICROPY_PERSISTENT_CODE_SAVE
        .bc_len = 112,
        .n_obj = 0,
        .n_raw_code = 0,
...
// frozen bytecode for file ssd1306.py, scope ssd1306__lt_module_gt__SSD1306_init_display
STATIC const byte bytecode_data_ssd1306__lt_module_gt__SSD1306_init_display[163] = {
    0x1b, 0x00, 0x00, 0x01, 0x00, 0x00, 0x13,
    MP_QSTR_init_display & 0xff, MP_QSTR_init_display >> 8,
    MP_QSTR_ssd1306_dot_py & 0xff, MP_QSTR_ssd1306_dot_py >> 8,
    0x81, 0x2b, 0x8e, 0x07, 0x70, 0x77, 0x1f, 0x83, 0x07, 0x56, 0x2b, 0x28, 0x00, 0x00, 0xff,
    0x14, 0x81, 0x2e, 
    0xa0, 
    0x80, 
    0x14, 0x80, 0x40, 
...
STATIC const mp_rom_obj_t const_table_data_ssd1306__lt_module_gt__SSD1306_init_display[1] = {
    MP_ROM_QSTR(MP_QSTR_self),
};
STATIC const mp_raw_code_t raw_code_ssd1306__lt_module_gt__SSD1306_init_display = {
    .kind = MP_CODE_BYTECODE,
    .scope_flags = 0x00,
    .n_pos_args = 1,
    .data.u_byte = {
        .bytecode = bytecode_data_ssd1306__lt_module_gt__SSD1306_init_display,
        .const_table = (mp_uint_t*)const_table_data_ssd1306__lt_module_gt__SSD1306_init_display,
        #if MICROPY_PERSISTENT_CODE_SAVE
        .bc_len = 163,
        .n_obj = 0,
        .n_raw_code = 0,
...
// frozen bytecode for file ssd1306.py, scope ssd1306__lt_module_gt__SSD1306_poweroff
STATIC const byte bytecode_data_ssd1306__lt_module_gt__SSD1306_poweroff[28] = {
    0x04, 0x00, 0x00, 0x01, 0x00, 0x00, 0x09,
    MP_QSTR_poweroff & 0xff, MP_QSTR_poweroff >> 8,
    MP_QSTR_ssd1306_dot_py & 0xff, MP_QSTR_ssd1306_dot_py >> 8,
    0x81, 0x45, 0x00, 0x00, 0xff,
    0xb0, 
    0x1e, MP_QSTR_write_cmd & 0xff, MP_QSTR_write_cmd >> 8,
    0x14, 0x81, 0x2e, 
    0x66, 0x01, 
...
STATIC const mp_rom_obj_t const_table_data_ssd1306__lt_module_gt__SSD1306_poweroff[1] = {
    MP_ROM_QSTR(MP_QSTR_self),
};
STATIC const mp_raw_code_t raw_code_ssd1306__lt_module_gt__SSD1306_poweroff = {
    .kind = MP_CODE_BYTECODE,
    .scope_flags = 0x00,
    .n_pos_args = 1,
    .data.u_byte = {
        .bytecode = bytecode_data_ssd1306__lt_module_gt__SSD1306_poweroff,
        .const_table = (mp_uint_t*)const_table_data_ssd1306__lt_module_gt__SSD1306_poweroff,
        #if MICROPY_PERSISTENT_CODE_SAVE
        .bc_len = 28,
        .n_obj = 0,
        .n_raw_code = 0,
...
// frozen bytecode for file ssd1306.py, scope ssd1306__lt_module_gt__SSD1306_contrast
STATIC const byte bytecode_data_ssd1306__lt_module_gt__SSD1306_contrast[37] = {
    0x05, 0x00, 0x00, 0x02, 0x00, 0x00, 0x0a,
    MP_QSTR_contrast & 0xff, MP_QSTR_contrast >> 8,
    MP_QSTR_ssd1306_dot_py & 0xff, MP_QSTR_ssd1306_dot_py >> 8,
    0x81, 0x47, 0x2a, 0x00, 0x00, 0xff,
    0xb0, 
    0x1e, MP_QSTR_write_cmd & 0xff, MP_QSTR_write_cmd >> 8,
    0x14, 0x81, 0x01, 
    0x66, 0x01, 
...
STATIC const mp_rom_obj_t const_table_data_ssd1306__lt_module_gt__SSD1306_contrast[2] = {
    MP_ROM_QSTR(MP_QSTR_self),
    MP_ROM_QSTR(MP_QSTR_contrast),
};
STATIC const mp_raw_code_t raw_code_ssd1306__lt_module_gt__SSD1306_contrast = {
    .kind = MP_CODE_BYTECODE,
    .scope_flags = 0x00,
    .n_pos_args = 2,
    .data.u_byte = {
        .bytecode = bytecode_data_ssd1306__lt_module_gt__SSD1306_contrast,
        .const_table = (mp_uint_t*)const_table_data_ssd1306__lt_module_gt__SSD1306_contrast,
        #if MICROPY_PERSISTENT_CODE_SAVE
        .bc_len = 37,
        .n_obj = 0,
        .n_raw_code = 0,
...
// frozen bytecode for file ssd1306.py, scope ssd1306__lt_module_gt__SSD1306_invert
STATIC const byte bytecode_data_ssd1306__lt_module_gt__SSD1306_invert[32] = {
...
STATIC const mp_rom_obj_t const_table_data_ssd1306__lt_module_gt__SSD1306_invert[2] = {
    MP_ROM_QSTR(MP_QSTR_self),
    MP_ROM_QSTR(MP_QSTR_invert),
};
STATIC const mp_raw_code_t raw_code_ssd1306__lt_module_gt__SSD1306_invert = {
    .kind = MP_CODE_BYTECODE,
    .scope_flags = 0x00,
    .n_pos_args = 2,
    .data.u_byte = {
        .bytecode = bytecode_data_ssd1306__lt_module_gt__SSD1306_invert,
        .const_table = (mp_uint_t*)const_table_data_ssd1306__lt_module_gt__SSD1306_invert,
        #if MICROPY_PERSISTENT_CODE_SAVE
        .bc_len = 32,
        .n_obj = 0,
        .n_raw_code = 0,
...
// frozen bytecode for file ssd1306.py, scope ssd1306__lt_module_gt__SSD1306_show
STATIC const byte bytecode_data_ssd1306__lt_module_gt__SSD1306_show[121] = {
    0x07, 0x00, 0x00, 0x01, 0x00, 0x00, 0x14,
    MP_QSTR_show & 0xff, MP_QSTR_show >> 8,
    MP_QSTR_ssd1306_dot_py & 0xff, MP_QSTR_ssd1306_dot_py >> 8,
    0x81, 0x4c, 0x22, 0x27, 0x4b, 0x24, 0x24, 0x28, 0x28, 0x28, 0x28, 0x28, 0x2d, 0x00, 0x00, 0xff,
    0x80, 
    0xc1, 
    0xb0, 
    0x1d, MP_QSTR_width & 0xff, MP_QSTR_width >> 8,
...
STATIC const mp_rom_obj_t const_table_data_ssd1306__lt_module_gt__SSD1306_show[1] = {
    MP_ROM_QSTR(MP_QSTR_self),
};
STATIC const mp_raw_code_t raw_code_ssd1306__lt_module_gt__SSD1306_show = {
    .kind = MP_CODE_BYTECODE,
    .scope_flags = 0x00,
    .n_pos_args = 1,
    .data.u_byte = {
        .bytecode = bytecode_data_ssd1306__lt_module_gt__SSD1306_show,
        .const_table = (mp_uint_t*)const_table_data_ssd1306__lt_module_gt__SSD1306_show,
        #if MICROPY_PERSISTENT_CODE_SAVE
        .bc_len = 121,
        .n_obj = 0,
        .n_raw_code = 0,
...
// frozen bytecode for file ssd1306.py, scope ssd1306__lt_module_gt__SSD1306_fill
STATIC const byte bytecode_data_ssd1306__lt_module_gt__SSD1306_fill[29] = {
    0x05, 0x00, 0x00, 0x02, 0x00, 0x00, 0x09,
    MP_QSTR_fill & 0xff, MP_QSTR_fill >> 8,
    MP_QSTR_ssd1306_dot_py & 0xff, MP_QSTR_ssd1306_dot_py >> 8,
    0x81, 0x5a, 0x00, 0x00, 0xff,
    0xb0, 
    0x1d, MP_QSTR_framebuf & 0xff, MP_QSTR_framebuf >> 8,
    0x1e, MP_QSTR_fill & 0xff, MP_QSTR_fill >> 8,
    0xb1, 
    0x66, 0x01, 
    0x32, 
...
STATIC const mp_rom_obj_t const_table_data_ssd1306__lt_module_gt__SSD1306_fill[2] = {
    MP_ROM_QSTR(MP_QSTR_self),
    MP_ROM_QSTR(MP_QSTR_col),
};
STATIC const mp_raw_code_t raw_code_ssd1306__lt_module_gt__SSD1306_fill = {
    .kind = MP_CODE_BYTECODE,
    .scope_flags = 0x00,
    .n_pos_args = 2,
    .data.u_byte = {
        .bytecode = bytecode_data_ssd1306__lt_module_gt__SSD1306_fill,
        .const_table = (mp_uint_t*)const_table_data_ssd1306__lt_module_gt__SSD1306_fill,
        #if MICROPY_PERSISTENT_CODE_SAVE
        .bc_len = 29,
        .n_obj = 0,
        .n_raw_code = 0,
...
// frozen bytecode for file ssd1306.py, scope ssd1306__lt_module_gt__SSD1306_pixel
STATIC const byte bytecode_data_ssd1306__lt_module_gt__SSD1306_pixel[31] = {
    0x09, 0x00, 0x00, 0x04, 0x00, 0x00, 0x09,
    MP_QSTR_pixel & 0xff, MP_QSTR_pixel >> 8,
    MP_QSTR_ssd1306_dot_py & 0xff, MP_QSTR_ssd1306_dot_py >> 8,
    0x81, 0x5c, 0x00, 0x00, 0xff,
    0xb0, 
    0x1d, MP_QSTR_framebuf & 0xff, MP_QSTR_framebuf >> 8,
...
STATIC const mp_rom_obj_t const_table_data_ssd1306__lt_module_gt__SSD1306_pixel[4] = {
    MP_ROM_QSTR(MP_QSTR_self),
    MP_ROM_QSTR(MP_QSTR_x),
    MP_ROM_QSTR(MP_QSTR_y),
    MP_ROM_QSTR(MP_QSTR_col),
};
STATIC const mp_raw_code_t raw_code_ssd1306__lt_module_gt__SSD1306_pixel = {
    .kind = MP_CODE_BYTECODE,
    .scope_flags = 0x00,
    .n_pos_args = 4,
    .data.u_byte = {
        .bytecode = bytecode_data_ssd1306__lt_module_gt__SSD1306_pixel,
        .const_table = (mp_uint_t*)const_table_data_ssd1306__lt_module_gt__SSD1306_pixel,
        #if MICROPY_PERSISTENT_CODE_SAVE
        .bc_len = 31,
        .n_obj = 0,
        .n_raw_code = 0,
...
// frozen bytecode for file ssd1306.py, scope ssd1306__lt_module_gt__SSD1306_scroll
STATIC const byte bytecode_data_ssd1306__lt_module_gt__SSD1306_scroll[30] = {
    0x07, 0x00, 0x00, 0x03, 0x00, 0x00, 0x09,
    MP_QSTR_scroll & 0xff, MP_QSTR_scroll >> 8,
    MP_QSTR_ssd1306_dot_py & 0xff, MP_QSTR_ssd1306_dot_py >> 8,
    0x81, 0x5e, 0x00, 0x00, 0xff,
    0xb0, 
    0x1d, MP_QSTR_framebuf & 0xff, MP_QSTR_framebuf >> 8,
    0x1e, MP_QSTR_scroll & 0xff, MP_QSTR_scroll >> 8,
    0xb1, 
    0xb2, 
    0x66, 0x02, 
    0x32, 
...
STATIC const mp_rom_obj_t const_table_data_ssd1306__lt_module_gt__SSD1306_scroll[3] = {
    MP_ROM_QSTR(MP_QSTR_self),
    MP_ROM_QSTR(MP_QSTR_dx),
    MP_ROM_QSTR(MP_QSTR_dy),
};
STATIC const mp_raw_code_t raw_code_ssd1306__lt_module_gt__SSD1306_scroll = {
    .kind = MP_CODE_BYTECODE,
    .scope_flags = 0x00,
    .n_pos_args = 3,
    .data.u_byte = {
        .bytecode = bytecode_data_ssd1306__lt_module_gt__SSD1306_scroll,
        .const_table = (mp_uint_t*)const_table_data_ssd1306__lt_module_gt__SSD1306_scroll,
        #if MICROPY_PERSISTENT_CODE_SAVE
        .bc_len = 30,
        .n_obj = 0,
        .n_raw_code = 0,
...
// frozen bytecode for file ssd1306.py, scope ssd1306__lt_module_gt__SSD1306_text
STATIC const byte bytecode_data_ssd1306__lt_module_gt__SSD1306_text[32] = {
    0x0b, 0x00, 0x00, 0x05, 0x00, 0x01, 0x09,
...
STATIC const mp_rom_obj_t const_table_data_ssd1306__lt_module_gt__SSD1306_text[5] = {
    MP_ROM_QSTR(MP_QSTR_self),
...
STATIC const mp_raw_code_t raw_code_ssd1306__lt_module_gt__SSD1306_text = {
    .kind = MP_CODE_BYTECODE,
    .scope_flags = 0x00,
    .n_pos_args = 5,
    .data.u_byte = {
        .bytecode = bytecode_data_ssd1306__lt_module_gt__SSD1306_text,
        .const_table = (mp_uint_t*)const_table_data_ssd1306__lt_module_gt__SSD1306_text,
        #if MICROPY_PERSISTENT_CODE_SAVE
        .bc_len = 32,
        .n_obj = 0,
        .n_raw_code = 0,
...
// frozen bytecode for file ssd1306.py, scope ssd1306__lt_module_gt__SSD1306_hline
STATIC const byte bytecode_data_ssd1306__lt_module_gt__SSD1306_hline[32] = {
    0x0b, 0x00, 0x00, 0x05, 0x00, 0x00, 0x09,
    MP_QSTR_hline & 0xff, MP_QSTR_hline >> 8,
    MP_QSTR_ssd1306_dot_py & 0xff, MP_QSTR_ssd1306_dot_py >> 8,
    0x81, 0x62, 0x00, 0x00, 0xff,
    0xb0, 
    0x1d, MP_QSTR_framebuf & 0xff, MP_QSTR_framebuf >> 8,
...
STATIC const mp_rom_obj_t const_table_data_ssd1306__lt_module_gt__SSD1306_hline[5] = {
    MP_ROM_QSTR(MP_QSTR_self),
    MP_ROM_QSTR(MP_QSTR_x),
    MP_ROM_QSTR(MP_QSTR_y),
...
STATIC const mp_raw_code_t raw_code_ssd1306__lt_module_gt__SSD1306_hline = {
    .kind = MP_CODE_BYTECODE,
    .scope_flags = 0x00,
    .n_pos_args = 5,
    .data.u_byte = {
        .bytecode = bytecode_data_ssd1306__lt_module_gt__SSD1306_hline,
        .const_table = (mp_uint_t*)const_table_data_ssd1306__lt_module_gt__SSD1306_hline,
        #if MICROPY_PERSISTENT_CODE_SAVE
        .bc_len = 32,
        .n_obj = 0,
        .n_raw_code = 0,
...
// frozen bytecode for file ssd1306.py, scope ssd1306__lt_module_gt__SSD1306_vline
STATIC const byte bytecode_data_ssd1306__lt_module_gt__SSD1306_vline[32] = {
    0x0b, 0x00, 0x00, 0x05, 0x00, 0x00, 0x09,
...
STATIC const mp_rom_obj_t const_table_data_ssd1306__lt_module_gt__SSD1306_vline[5] = {
    MP_ROM_QSTR(MP_QSTR_self),
    MP_ROM_QSTR(MP_QSTR_x),
    MP_ROM_QSTR(MP_QSTR_y),
...
STATIC const mp_raw_code_t raw_code_ssd1306__lt_module_gt__SSD1306_vline = {
    .kind = MP_CODE_BYTECODE,
    .scope_flags = 0x00,
    .n_pos_args = 5,
    .data.u_byte = {
        .bytecode = bytecode_data_ssd1306__lt_module_gt__SSD1306_vline,
        .const_table = (mp_uint_t*)const_table_data_ssd1306__lt_module_gt__SSD1306_vline,
        #if MICROPY_PERSISTENT_CODE_SAVE
        .bc_len = 32,
        .n_obj = 0,
        .n_raw_code = 0,
...
// frozen bytecode for file ssd1306.py, scope ssd1306__lt_module_gt__SSD1306_line
STATIC const byte bytecode_data_ssd1306__lt_module_gt__SSD1306_line[33] = {
    0x0d, 0x00, 0x00, 0x06, 0x00, 0x00, 0x09,
...
STATIC const mp_rom_obj_t const_table_data_ssd1306__lt_module_gt__SSD1306_line[6] = {
    MP_ROM_QSTR(MP_QSTR_self),
...
STATIC const mp_raw_code_t raw_code_ssd1306__lt_module_gt__SSD1306_line = {
    .kind = MP_CODE_BYTECODE,
    .scope_flags = 0x00,
    .n_pos_args = 6,
    .data.u_byte = {
        .bytecode = bytecode_data_ssd1306__lt_module_gt__SSD1306_line,
        .const_table = (mp_uint_t*)const_table_data_ssd1306__lt_module_gt__SSD1306_line,
        #if MICROPY_PERSISTENT_CODE_SAVE
        .bc_len = 33,
        .n_obj = 0,
        .n_raw_code = 0,
...
// frozen bytecode for file ssd1306.py, scope ssd1306__lt_module_gt__SSD1306_rect
STATIC const byte bytecode_data_ssd1306__lt_module_gt__SSD1306_rect[33] = {
    0x0d, 0x00, 0x00, 0x06, 0x00, 0x00, 0x09,
...
STATIC const mp_rom_obj_t const_table_data_ssd1306__lt_module_gt__SSD1306_rect[6] = {
    MP_ROM_QSTR(MP_QSTR_self),
    MP_ROM_QSTR(MP_QSTR_x),
    MP_ROM_QSTR(MP_QSTR_y),
    MP_ROM_QSTR(MP_QSTR_w),
...
STATIC const mp_raw_code_t raw_code_ssd1306__lt_module_gt__SSD1306_rect = {
    .kind = MP_CODE_BYTECODE,
    .scope_flags = 0x00,
    .n_pos_args = 6,
    .data.u_byte = {
        .bytecode = bytecode_data_ssd1306__lt_module_gt__SSD1306_rect,
        .const_table = (mp_uint_t*)const_table_data_ssd1306__lt_module_gt__SSD1306_rect,
        #if MICROPY_PERSISTENT_CODE_SAVE
        .bc_len = 33,
        .n_obj = 0,
        .n_raw_code = 0,
...
// frozen bytecode for file ssd1306.py, scope ssd1306__lt_module_gt__SSD1306_fill_rect
STATIC const byte bytecode_data_ssd1306__lt_module_gt__SSD1306_fill_rect[33] = {
    0x0d, 0x00, 0x00, 0x06, 0x00, 0x00, 0x09,
...
STATIC const mp_rom_obj_t const_table_data_ssd1306__lt_module_gt__SSD1306_fill_rect[6] = {
    MP_ROM_QSTR(MP_QSTR_self),
    MP_ROM_QSTR(MP_QSTR_x),
    MP_ROM_QSTR(MP_QSTR_y),
    MP_ROM_QSTR(MP_QSTR_w),
...
STATIC const mp_raw_code_t raw_code_ssd1306__lt_module_gt__SSD1306_fill_rect = {
    .kind = MP_CODE_BYTECODE,
    .scope_flags = 0x00,
    .n_pos_args = 6,
    .data.u_byte = {
        .bytecode = bytecode_data_ssd1306__lt_module_gt__SSD1306_fill_rect,
        .const_table = (mp_uint_t*)const_table_data_ssd1306__lt_module_gt__SSD1306_fill_rect,
        #if MICROPY_PERSISTENT_CODE_SAVE
        .bc_len = 33,
        .n_obj = 0,
        .n_raw_code = 0,
...
// frozen bytecode for file ssd1306.py, scope ssd1306__lt_module_gt__SSD1306_blit
STATIC const byte bytecode_data_ssd1306__lt_module_gt__SSD1306_blit[31] = {
    0x09, 0x00, 0x00, 0x04, 0x00, 0x00, 0x09,
    MP_QSTR_blit & 0xff, MP_QSTR_blit >> 8,
    MP_QSTR_ssd1306_dot_py & 0xff, MP_QSTR_ssd1306_dot_py >> 8,
...
STATIC const mp_rom_obj_t const_table_data_ssd1306__lt_module_gt__SSD1306_blit[4] = {
    MP_ROM_QSTR(MP_QSTR_self),
    MP_ROM_QSTR(MP_QSTR_fbuf),
    MP_ROM_QSTR(MP_QSTR_x),
    MP_ROM_QSTR(MP_QSTR_y),
};
STATIC const mp_raw_code_t raw_code_ssd1306__lt_module_gt__SSD1306_blit = {
    .kind = MP_CODE_BYTECODE,
    .scope_flags = 0x00,
    .n_pos_args = 4,
    .data.u_byte = {
        .bytecode = bytecode_data_ssd1306__lt_module_gt__SSD1306_blit,
        .const_table = (mp_uint_t*)const_table_data_ssd1306__lt_module_gt__SSD1306_blit,
        #if MICROPY_PERSISTENT_CODE_SAVE
        .bc_len = 31,
        .n_obj = 0,
        .n_raw_code = 0,
...
// frozen bytecode for file ssd1306.py, scope ssd1306__lt_module_gt__SSD1306
STATIC const byte bytecode_data_ssd1306__lt_module_gt__SSD1306[132] = {
    0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x1b,
    MP_QSTR_SSD1306 & 0xff, MP_QSTR_SSD1306 >> 8,
    MP_QSTR_ssd1306_dot_py & 0xff, MP_QSTR_ssd1306_dot_py >> 8,
    0x8d, 0x21, 0x85, 0x09, 0x85, 0x1a, 0x45, 0x65, 0x45, 0x85, 0x0e, 0x45, 0x45, 0x45, 0x49, 0x45, 0x45, 0x45, 0x45, 0x45, 0x00, 0x00, 0xff,
    0x1b, MP_QSTR___name__ & 0xff, MP_QSTR___name__ >> 8,
    0x24, MP_QSTR___module__ & 0xff, MP_QSTR___module__ >> 8,
    0x16, MP_QSTR_SSD1306 & 0xff, MP_QSTR_SSD1306 >> 8,
    0x24, MP_QSTR___qualname__ & 0xff, MP_QSTR___qualname__ >> 8,
    0x60, 0x00, 
    0x24, MP_QSTR___init__ & 0xff, MP_QSTR___init__ >> 8,
    0x60, 0x01, 
    ...
    0x24, MP_QSTR_fill & 0xff, MP_QSTR_fill >> 8,
    0x60, 0x07, 
    0x24, MP_QSTR_pixel & 0xff, MP_QSTR_pixel >> 8,
    0x60, 0x08, 
    0x24, MP_QSTR_scroll & 0xff, MP_QSTR_scroll >> 8,
    0x81, 
    0x50, 0x01, 
    0x18, 
    0x61, 0x09, 
    ...
    0x60, 0x0f, 
    0x24, MP_QSTR_blit & 0xff, MP_QSTR_blit >> 8,
    0x11, 
    0x5b, 
};
STATIC const mp_rom_obj_t const_table_data_ssd1306__lt_module_gt__SSD1306[16] = {
    MP_ROM_PTR(&raw_code_ssd1306__lt_module_gt__SSD1306___init__),
    MP_ROM_PTR(&raw_code_ssd1306__lt_module_gt__SSD1306_init_display),
    MP_ROM_PTR(&raw_code_ssd1306__lt_module_gt__SSD1306_poweroff),
    MP_ROM_PTR(&raw_code_ssd1306__lt_module_gt__SSD1306_contrast),
    MP_ROM_PTR(&raw_code_ssd1306__lt_module_gt__SSD1306_invert),
    MP_ROM_PTR(&raw_code_ssd1306__lt_module_gt__SSD1306_show),
    MP_ROM_PTR(&raw_code_ssd1306__lt_module_gt__SSD1306_fill),
    MP_ROM_PTR(&raw_code_ssd1306__lt_module_gt__SSD1306_pixel),
    MP_ROM_PTR(&raw_code_ssd1306__lt_module_gt__SSD1306_scroll),
    MP_ROM_PTR(&raw_code_ssd1306__lt_module_gt__SSD1306_text),
    MP_ROM_PTR(&raw_code_ssd1306__lt_module_gt__SSD1306_hline),
    MP_ROM_PTR(&raw_code_ssd1306__lt_module_gt__SSD1306_vline),
    MP_ROM_PTR(&raw_code_ssd1306__lt_module_gt__SSD1306_line),
    MP_ROM_PTR(&raw_code_ssd1306__lt_module_gt__SSD1306_rect),
    MP_ROM_PTR(&raw_code_ssd1306__lt_module_gt__SSD1306_fill_rect),
    MP_ROM_PTR(&raw_code_ssd1306__lt_module_gt__SSD1306_blit),
};
STATIC const mp_raw_code_t raw_code_ssd1306__lt_module_gt__SSD1306 = {
    .kind = MP_CODE_BYTECODE,
    .scope_flags = 0x00,
    .n_pos_args = 0,
    .data.u_byte = {
        .bytecode = bytecode_data_ssd1306__lt_module_gt__SSD1306,
        .const_table = (mp_uint_t*)const_table_data_ssd1306__lt_module_gt__SSD1306,
        #if MICROPY_PERSISTENT_CODE_SAVE
        .bc_len = 132,
        .n_obj = 0,
        .n_raw_code = 16,
...
// frozen bytecode for file ssd1306.py, scope ssd1306__lt_module_gt__SSD1306_I2C___init__
STATIC const byte bytecode_data_ssd1306__lt_module_gt__SSD1306_I2C___init__[56] = {
    0x0c, 0x00, 0x00, 0x07, 0x00, 0x02, 0x0c,
    MP_QSTR___init__ & 0xff, MP_QSTR___init__ >> 8,
    MP_QSTR_ssd1306_dot_py & 0xff, MP_QSTR_ssd1306_dot_py >> 8,
    0x81, 0x70, 0x25, 0x25, 0x2a, 0x00, 0x00, 0xff,
    0xb4, 
    0xb1, 
...
STATIC const mp_rom_obj_t const_table_data_ssd1306__lt_module_gt__SSD1306_I2C___init__[7] = {
    MP_ROM_QSTR(MP_QSTR__star_),
    MP_ROM_QSTR(MP_QSTR_self),
    MP_ROM_QSTR(MP_QSTR_width),
    MP_ROM_QSTR(MP_QSTR_height),
...
STATIC const mp_raw_code_t raw_code_ssd1306__lt_module_gt__SSD1306_I2C___init__ = {
    .kind = MP_CODE_BYTECODE,
    .scope_flags = 0x00,
    .n_pos_args = 7,
    .data.u_byte = {
        .bytecode = bytecode_data_ssd1306__lt_module_gt__SSD1306_I2C___init__,
        .const_table = (mp_uint_t*)const_table_data_ssd1306__lt_module_gt__SSD1306_I2C___init__,
        #if MICROPY_PERSISTENT_CODE_SAVE
        .bc_len = 56,
        .n_obj = 0,
        .n_raw_code = 0,
...
// frozen bytecode for file ssd1306.py, scope ssd1306__lt_module_gt__SSD1306_I2C_write_cmd
STATIC const byte bytecode_data_ssd1306__lt_module_gt__SSD1306_I2C_write_cmd[112] = {
    0x06, 0x00, 0x00, 0x02, 0x00, 0x00, 0x0f,
    MP_QSTR_write_cmd & 0xff, MP_QSTR_write_cmd >> 8,
    MP_QSTR_ssd1306_dot_py & 0xff, MP_QSTR_ssd1306_dot_py >> 8,
    0x81, 0x75, 0x29, 0x47, 0x20, 0x34, 0x35, 0x2a, 0x00, 0x00, 0xff,
    0x14, 0x81, 0x00, 
    0xb0, 
    ...
    0x81, 
    0x27, 
    0x1c, MP_QSTR_currentBoard & 0xff, MP_QSTR_currentBoard >> 8,
    ...
    0x35, 0x1f, 0x80, 
    0x1c, MP_QSTR_currentBoard & 0xff, MP_QSTR_currentBoard >> 8,
    0x16, MP_QSTR_pyboard & 0xff, MP_QSTR_pyboard >> 8,
    0xd9, 
    0x37, 0x15, 0x80, 
    0xb0, 
    0x1d, MP_QSTR_i2c & 0xff, MP_QSTR_i2c >> 8,
...
STATIC const mp_rom_obj_t const_table_data_ssd1306__lt_module_gt__SSD1306_I2C_write_cmd[2] = {
    MP_ROM_QSTR(MP_QSTR_self),
    MP_ROM_QSTR(MP_QSTR_cmd),
};
STATIC const mp_raw_code_t raw_code_ssd1306__lt_module_gt__SSD1306_I2C_write_cmd = {
    .kind = MP_CODE_BYTECODE,
    .scope_flags = 0x00,
    .n_pos_args = 2,
    .data.u_byte = {
        .bytecode = bytecode_data_ssd1306__lt_module_gt__SSD1306_I2C_write_cmd,
        .const_table = (mp_uint_t*)const_table_data_ssd1306__lt_module_gt__SSD1306_I2C_write_cmd,
        #if MICROPY_PERSISTENT_CODE_SAVE
        .bc_len = 112,
        .n_obj = 0,
        .n_raw_code = 0,
...
// frozen bytecode for file ssd1306.py, scope ssd1306__lt_module_gt__SSD1306_I2C_write_data
STATIC const byte bytecode_data_ssd1306__lt_module_gt__SSD1306_I2C_write_data[147] = {
    0x07, 0x00, 0x00, 0x02, 0x00, 0x00, 0x12,
    MP_QSTR_write_data & 0xff, MP_QSTR_write_data >> 8,
    MP_QSTR_ssd1306_dot_py & 0xff, MP_QSTR_ssd1306_dot_py >> 8,
    0x81, 0x80, 0x2c, 0x29, 0x20, 0x34, 0x2a, 0x2e, 0x2b, 0x2d, 0x6a, 0x00, 0x00, 0xff,
    0xb0, 
    0x1d, MP_QSTR_addr & 0xff, MP_QSTR_addr >> 8,
    0x81, 
    0xef, 
    ...
    0xb0, 
    0x1d, MP_QSTR_i2c & 0xff, MP_QSTR_i2c >> 8,
    0x1e, MP_QSTR_mem_write & 0xff, MP_QSTR_mem_write >> 8,
    0xb1, 
    0xb0, 
    0x1d, MP_QSTR_addr & 0xff, MP_QSTR_addr >> 8,
    0x14, 0x80, 0x40, 
...
STATIC const mp_rom_obj_t const_table_data_ssd1306__lt_module_gt__SSD1306_I2C_write_data[2] = {
    MP_ROM_QSTR(MP_QSTR_self),
    MP_ROM_QSTR(MP_QSTR_buf),
};
STATIC const mp_raw_code_t raw_code_ssd1306__lt_module_gt__SSD1306_I2C_write_data = {
    .kind = MP_CODE_BYTECODE,
    .scope_flags = 0x00,
    .n_pos_args = 2,
    .data.u_byte = {
        .bytecode = bytecode_data_ssd1306__lt_module_gt__SSD1306_I2C_write_data,
        .const_table = (mp_uint_t*)const_table_data_ssd1306__lt_module_gt__SSD1306_I2C_write_data,
        #if MICROPY_PERSISTENT_CODE_SAVE
        .bc_len = 147,
        .n_obj = 0,
        .n_raw_code = 0,
...
// frozen bytecode for file ssd1306.py, scope ssd1306__lt_module_gt__SSD1306_I2C_poweron
STATIC const byte bytecode_data_ssd1306__lt_module_gt__SSD1306_I2C_poweron[18] = {
    0x02, 0x00, 0x00, 0x01, 0x00, 0x00, 0x09,
    MP_QSTR_poweron & 0xff, MP_QSTR_poweron >> 8,
    MP_QSTR_ssd1306_dot_py & 0xff, MP_QSTR_ssd1306_dot_py >> 8,
    0x81, 0x8d, 0x00, 0x00, 0xff,
    0x11, 
    0x5b, 
};
STATIC const mp_rom_obj_t const_table_data_ssd1306__lt_module_gt__SSD1306_I2C_poweron[1] = {
    MP_ROM_QSTR(MP_QSTR_self),
};
STATIC const mp_raw_code_t raw_code_ssd1306__lt_module_gt__SSD1306_I2C_poweron = {
    .kind = MP_CODE_BYTECODE,
    .scope_flags = 0x00,
    .n_pos_args = 1,
    .data.u_byte = {
        .bytecode = bytecode_data_ssd1306__lt_module_gt__SSD1306_I2C_poweron,
        .const_table = (mp_uint_t*)const_table_data_ssd1306__lt_module_gt__SSD1306_I2C_poweron,
        #if MICROPY_PERSISTENT_CODE_SAVE
        .bc_len = 18,
        .n_obj = 0,
        .n_raw_code = 0,
...
// frozen bytecode for file ssd1306.py, scope ssd1306__lt_module_gt__SSD1306_I2C
STATIC const byte bytecode_data_ssd1306__lt_module_gt__SSD1306_I2C[65] = {
    0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0f,
    MP_QSTR_SSD1306_I2C & 0xff, MP_QSTR_SSD1306_I2C >> 8,
    MP_QSTR_ssd1306_dot_py & 0xff, MP_QSTR_ssd1306_dot_py >> 8,
    0x8e, 0x6f, 0x6d, 0x40, 0x85, 0x0b, 0x85, 0x0d, 0x00, 0x00, 0x00, 0xff,
    0x1b, MP_QSTR___name__ & 0xff, MP_QSTR___name__ >> 8,
    0x24, MP_QSTR___module__ & 0xff, MP_QSTR___module__ >> 8,
    0x16, MP_QSTR_SSD1306_I2C & 0xff, MP_QSTR_SSD1306_I2C >> 8,
    0x24, MP_QSTR___qualname__ & 0xff, MP_QSTR___qualname__ >> 8,
    0x14, 0x3c, 
    0x10, 
    0x50, 0x02, 
...
STATIC const mp_rom_obj_t const_table_data_ssd1306__lt_module_gt__SSD1306_I2C[4] = {
    MP_ROM_PTR(&raw_code_ssd1306__lt_module_gt__SSD1306_I2C___init__),
    MP_ROM_PTR(&raw_code_ssd1306__lt_module_gt__SSD1306_I2C_write_cmd),
    MP_ROM_PTR(&raw_code_ssd1306__lt_module_gt__SSD1306_I2C_write_data),
    MP_ROM_PTR(&raw_code_ssd1306__lt_module_gt__SSD1306_I2C_poweron),
};
STATIC const mp_raw_code_t raw_code_ssd1306__lt_module_gt__SSD1306_I2C = {
    .kind = MP_CODE_BYTECODE,
    .scope_flags = 0x00,
    .n_pos_args = 0,
    .data.u_byte = {
        .bytecode = bytecode_data_ssd1306__lt_module_gt__SSD1306_I2C,
        .const_table = (mp_uint_t*)const_table_data_ssd1306__lt_module_gt__SSD1306_I2C,
        #if MICROPY_PERSISTENT_CODE_SAVE
        .bc_len = 65,
        .n_obj = 0,
        .n_raw_code = 4,
...
// frozen bytecode for file ssd1306.py, scope ssd1306__lt_module_gt__SSD1306_SPI___init__
STATIC const byte bytecode_data_ssd1306__lt_module_gt__SSD1306_SPI___init__[118] = {
    0x0e, 0x00, 0x00, 0x09, 0x00, 0x01, 0x11,
    MP_QSTR___init__ & 0xff, MP_QSTR___init__ >> 8,
    MP_QSTR_ssd1306_dot_py & 0xff, MP_QSTR_ssd1306_dot_py >> 8,
    0x81, 0x91, 0x29, 0x30, 0x30, 0x30, 0x25, 0x25, 0x25, 0x25, 0x00, 0x00, 0xff,
...
STATIC const mp_rom_obj_t const_table_data_ssd1306__lt_module_gt__SSD1306_SPI___init__[9] = {
    MP_ROM_QSTR(MP_QSTR__star_),
    MP_ROM_QSTR(MP_QSTR_self),
    MP_ROM_QSTR(MP_QSTR_width),
    MP_ROM_QSTR(MP_QSTR_height),
...
STATIC const mp_raw_code_t raw_code_ssd1306__lt_module_gt__SSD1306_SPI___init__ = {
    .kind = MP_CODE_BYTECODE,
    .scope_flags = 0x00,
    .n_pos_args = 9,
    .data.u_byte = {
        .bytecode = bytecode_data_ssd1306__lt_module_gt__SSD1306_SPI___init__,
        .const_table = (mp_uint_t*)const_table_data_ssd1306__lt_module_gt__SSD1306_SPI___init__,
        #if MICROPY_PERSISTENT_CODE_SAVE
        .bc_len = 118,
        .n_obj = 0,
        .n_raw_code = 0,
...
// frozen bytecode for file ssd1306.py, scope ssd1306__lt_module_gt__SSD1306_SPI_write_cmd
STATIC const byte bytecode_data_ssd1306__lt_module_gt__SSD1306_SPI_write_cmd[244] = {
    0x0c, 0x00, 0x00, 0x02, 0x00, 0x00, 0x17,
    MP_QSTR_write_cmd & 0xff, MP_QSTR_write_cmd >> 8,
    MP_QSTR_ssd1306_dot_py & 0xff, MP_QSTR_ssd1306_dot_py >> 8,
    0x81, 0x9b, 0x20, 0x34, 0x3d, 0x2a, 0x1f, 0x2a, 0x2a, 0x2a, 0x2a, 0x20, 0x34, 0x35, 0x2a, 0x35, 0x00, 0x00, 0xff,
    0x1c, MP_QSTR_currentBoard & 0xff, MP_QSTR_currentBoard >> 8,
    0x16, MP_QSTR_esp8266 & 0xff, MP_QSTR_esp8266 >> 8,
    0xd9, 
    0x36, 0x0a, 0x80, 
    ...
    0x1d, MP_QSTR_spi & 0xff, MP_QSTR_spi >> 8,
    0x1e, MP_QSTR_init & 0xff, MP_QSTR_init >> 8,
    0x16, MP_QSTR_mode & 0xff, MP_QSTR_mode >> 8,
    0x1c, MP_QSTR_pyb & 0xff, MP_QSTR_pyb >> 8,
    0x1d, MP_QSTR_SPI & 0xff, MP_QSTR_SPI >> 8,
    0x1d, MP_QSTR_MASTER & 0xff, MP_QSTR_MASTER >> 8,
    0x16, MP_QSTR_baudrate & 0xff, MP_QSTR_baudrate >> 8,
    0xb0, 
    0x1d, MP_QSTR_rate & 0xff, MP_QSTR_rate >> 8,
    0x16, MP_QSTR_polarity & 0xff, MP_QSTR_polarity >> 8,
    ...
    0x35, 0x00, 0x80, 
    0xb0, 
    0x1d, MP_QSTR_cs & 0xff, MP_QSTR_cs >> 8,
    0x1e, MP_QSTR_high & 0xff, MP_QSTR_high >> 8,
    0x66, 0x00, 
    0x32, 
    0xb0, 
    0x1d, MP_QSTR_dc & 0xff, MP_QSTR_dc >> 8,
    0x1e, MP_QSTR_low & 0xff, MP_QSTR_low >> 8,
    0x66, 0x00, 
    0x32, 
    0xb0, 
    0x1d, MP_QSTR_cs & 0xff, MP_QSTR_cs >> 8,
...
STATIC const mp_rom_obj_t const_table_data_ssd1306__lt_module_gt__SSD1306_SPI_write_cmd[2] = {
    MP_ROM_QSTR(MP_QSTR_self),
    MP_ROM_QSTR(MP_QSTR_cmd),
};
STATIC const mp_raw_code_t raw_code_ssd1306__lt_module_gt__SSD1306_SPI_write_cmd = {
    .kind = MP_CODE_BYTECODE,
    .scope_flags = 0x00,
    .n_pos_args = 2,
    .data.u_byte = {
        .bytecode = bytecode_data_ssd1306__lt_module_gt__SSD1306_SPI_write_cmd,
        .const_table = (mp_uint_t*)const_table_data_ssd1306__lt_module_gt__SSD1306_SPI_write_cmd,
        #if MICROPY_PERSISTENT_CODE_SAVE
        .bc_len = 244,
        .n_obj = 0,
        .n_raw_code = 0,
...
// frozen bytecode for file ssd1306.py, scope ssd1306__lt_module_gt__SSD1306_SPI_write_data
STATIC const byte bytecode_data_ssd1306__lt_module_gt__SSD1306_SPI_write_data[230] = {
    0x0c, 0x00, 0x00, 0x02, 0x00, 0x00, 0x17,
    MP_QSTR_write_data & 0xff, MP_QSTR_write_data >> 8,
    MP_QSTR_ssd1306_dot_py & 0xff, MP_QSTR_ssd1306_dot_py >> 8,
    0x81, 0xaa, 0x20, 0x34, 0x3d, 0x2a, 0x1f, 0x2a, 0x2a, 0x2a, 0x2a, 0x20, 0x34, 0x2e, 0x2a, 0x2e, 0x00, 0x00, 0xff,
    0x1c, MP_QSTR_currentBoard & 0xff, MP_QSTR_currentBoard >> 8,
    0x16, MP_QSTR_esp8266 & 0xff, MP_QSTR_esp8266 >> 8,
    0xd9, 
    0x36, 0x0a, 0x80, 
...
STATIC const mp_rom_obj_t const_table_data_ssd1306__lt_module_gt__SSD1306_SPI_write_data[2] = {
    MP_ROM_QSTR(MP_QSTR_self),
    MP_ROM_QSTR(MP_QSTR_buf),
};
STATIC const mp_raw_code_t raw_code_ssd1306__lt_module_gt__SSD1306_SPI_write_data = {
    .kind = MP_CODE_BYTECODE,
    .scope_flags = 0x00,
    .n_pos_args = 2,
    .data.u_byte = {
        .bytecode = bytecode_data_ssd1306__lt_module_gt__SSD1306_SPI_write_data,
        .const_table = (mp_uint_t*)const_table_data_ssd1306__lt_module_gt__SSD1306_SPI_write_data,
        #if MICROPY_PERSISTENT_CODE_SAVE
        .bc_len = 230,
        .n_obj = 0,
        .n_raw_code = 0,
...
// frozen bytecode for file ssd1306.py, scope ssd1306__lt_module_gt__SSD1306_SPI_poweron
STATIC const byte bytecode_data_ssd1306__lt_module_gt__SSD1306_SPI_poweron[72] = {
    0x04, 0x00, 0x00, 0x01, 0x00, 0x00, 0x0d,
    MP_QSTR_poweron & 0xff, MP_QSTR_poweron >> 8,
    MP_QSTR_ssd1306_dot_py & 0xff, MP_QSTR_ssd1306_dot_py >> 8,
    0x81, 0xb9, 0x2a, 0x2a, 0x2a, 0x2a, 0x00, 0x00, 0xff,
    0xb0, 
    0x1d, MP_QSTR_res & 0xff, MP_QSTR_res >> 8,
    0x1e, MP_QSTR_high & 0xff, MP_QSTR_high >> 8,
    0x66, 0x00, 
    0x32, 
    0x1c, MP_QSTR_time & 0xff, MP_QSTR_time >> 8,
...
STATIC const mp_rom_obj_t const_table_data_ssd1306__lt_module_gt__SSD1306_SPI_poweron[1] = {
    MP_ROM_QSTR(MP_QSTR_self),
};
STATIC const mp_raw_code_t raw_code_ssd1306__lt_module_gt__SSD1306_SPI_poweron = {
    .kind = MP_CODE_BYTECODE,
    .scope_flags = 0x00,
    .n_pos_args = 1,
    .data.u_byte = {
        .bytecode = bytecode_data_ssd1306__lt_module_gt__SSD1306_SPI_poweron,
        .const_table = (mp_uint_t*)const_table_data_ssd1306__lt_module_gt__SSD1306_SPI_poweron,
        #if MICROPY_PERSISTENT_CODE_SAVE
        .bc_len = 72,
        .n_obj = 0,
        .n_raw_code = 0,
...
// frozen bytecode for file ssd1306.py, scope ssd1306__lt_module_gt__SSD1306_SPI
STATIC const byte bytecode_data_ssd1306__lt_module_gt__SSD1306_SPI[63] = {
    0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0f,
    MP_QSTR_SSD1306_SPI & 0xff, MP_QSTR_SSD1306_SPI >> 8,
    MP_QSTR_ssd1306_dot_py & 0xff, MP_QSTR_ssd1306_dot_py >> 8,
    0x8e, 0x90, 0x8b, 0x0a, 0x85, 0x0f, 0x85, 0x0f, 0x00, 0x00, 0x00, 0xff,
    0x1b, MP_QSTR___name__ & 0xff, MP_QSTR___name__ >> 8,
    0x24, MP_QSTR___module__ & 0xff, MP_QSTR___module__ >> 8,
    0x16, MP_QSTR_SSD1306_SPI & 0xff, MP_QSTR_SSD1306_SPI >> 8,
    0x24, MP_QSTR___qualname__ & 0xff, MP_QSTR___qualname__ >> 8,
    0x10, 
    0x50, 0x01, 
    0x18, 
...
STATIC const mp_rom_obj_t const_table_data_ssd1306__lt_module_gt__SSD1306_SPI[4] = {
    MP_ROM_PTR(&raw_code_ssd1306__lt_module_gt__SSD1306_SPI___init__),
    MP_ROM_PTR(&raw_code_ssd1306__lt_module_gt__SSD1306_SPI_write_cmd),
    MP_ROM_PTR(&raw_code_ssd1306__lt_module_gt__SSD1306_SPI_write_data),
    MP_ROM_PTR(&raw_code_ssd1306__lt_module_gt__SSD1306_SPI_poweron),
};
STATIC const mp_raw_code_t raw_code_ssd1306__lt_module_gt__SSD1306_SPI = {
    .kind = MP_CODE_BYTECODE,
    .scope_flags = 0x00,
    .n_pos_args = 0,
    .data.u_byte = {
        .bytecode = bytecode_data_ssd1306__lt_module_gt__SSD1306_SPI,
        .const_table = (mp_uint_t*)const_table_data_ssd1306__lt_module_gt__SSD1306_SPI,
        #if MICROPY_PERSISTENT_CODE_SAVE
        .bc_len = 63,
        .n_obj = 0,
        .n_raw_code = 4,
...
// frozen bytecode for file ssd1306.py, scope ssd1306_<module>
STATIC const byte bytecode_data_ssd1306__lt_module_gt_[305] = {
    0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x29,
    MP_QSTR__lt_module_gt_ & 0xff, MP_QSTR__lt_module_gt_ >> 8,
    MP_QSTR_ssd1306_dot_py & 0xff, MP_QSTR_ssd1306_dot_py >> 8,
    0x21, 0x30, 0x28, 0x28, 0x48, 0x26, 0x2d, 0x29, 0x2d, 0x29, 0x2d, 0x26, 0x4b, 0x26, 0x26, 0x26, 0x26, 0x24, 0x24, 0x24, 0x26, 0x26, 0x26, 0x26, 0x26, 0x26, 0x26, 0x26, 0x26, 0x26, 0x8b, 0x4e, 0x8e, 0x21, 0x00, 0x00, 0xff,
    0x80, 
    0x16, MP_QSTR_const & 0xff, MP_QSTR_const >> 8,
    0x50, 0x01, 
    0x68, MP_QSTR_micropython & 0xff, MP_QSTR_micropython >> 8,
    ...
    0x25, MP_QSTR_currentBoard & 0xff, MP_QSTR_currentBoard >> 8,
    ...
    0x11, 
    0x68, MP_QSTR_pyb & 0xff, MP_QSTR_pyb >> 8,
    0x24, MP_QSTR_pyb & 0xff, MP_QSTR_pyb >> 8,
    0x35, 0x00, 0x80, 
    0x14, 0x81, 0x01, 
    ...
    0x14, 0x81, 0x2e, 
    0x24, MP_QSTR_SET_DISP & 0xff, MP_QSTR_SET_DISP >> 8,
    0xa0, 
    ...
    0x16, MP_QSTR_SSD1306 & 0xff, MP_QSTR_SSD1306 >> 8,
    0x64, 0x02, 
    0x24, MP_QSTR_SSD1306 & 0xff, MP_QSTR_SSD1306 >> 8,
    0x20, 
    0x60, 0x01, 
    0x16, MP_QSTR_SSD1306_I2C & 0xff, MP_QSTR_SSD1306_I2C >> 8,
    0x1b, MP_QSTR_SSD1306 & 0xff, MP_QSTR_SSD1306 >> 8,
    0x64, 0x03, 
    0x24, MP_QSTR_SSD1306_I2C & 0xff, MP_QSTR_SSD1306_I2C >> 8,
    0x20, 
    0x60, 0x02, 
    0x16, MP_QSTR_SSD1306_SPI & 0xff, MP_QSTR_SSD1306_SPI >> 8,
    0x1b, MP_QSTR_SSD1306 & 0xff, MP_QSTR_SSD1306 >> 8,
    0x64, 0x03, 
    0x24, MP_QSTR_SSD1306_SPI & 0xff, MP_QSTR_SSD1306_SPI >> 8,
    0x11, 
    0x5b, 
};
STATIC const mp_rom_obj_t const_table_data_ssd1306__lt_module_gt_[3] = {
    MP_ROM_PTR(&raw_code_ssd1306__lt_module_gt__SSD1306),
    MP_ROM_PTR(&raw_code_ssd1306__lt_module_gt__SSD1306_I2C),
    MP_ROM_PTR(&raw_code_ssd1306__lt_module_gt__SSD1306_SPI),
};
const mp_raw_code_t raw_code_ssd1306__lt_module_gt_ = {
    .kind = MP_CODE_BYTECODE,
    .scope_flags = 0x00,
    .n_pos_args = 0,
    .data.u_byte = {
        .bytecode = bytecode_data_ssd1306__lt_module_gt_,
        .const_table = (mp_uint_t*)const_table_data_ssd1306__lt_module_gt_,
        #if MICROPY_PERSISTENT_CODE_SAVE
        .bc_len = 305,
        .n_obj = 0,
        .n_raw_code = 3,
...
STATIC const byte bytecode_data_upip__lt_module_gt__url_open[350] = {
    0x13, 0x02, 0x00, 0x01, 0x00, 0x00, 0x28,
    MP_QSTR_url_open & 0xff, MP_QSTR_url_open >> 8,
    MP_QSTR_upip_dot_py & 0xff, MP_QSTR_upip_dot_py >> 8,
    0x81, 0x69, 0x40, 0x26, 0x47, 0x30, 0x23, 0x5d, 0x57, 0x46, 0x2e, 0x43, 0x48, 0x28, 0x2f, 0x26, 0x2a, 0x64, 0x2e, 0x27, 0x2d, 0x27, 0x2e, 0x29, 0x28, 0x20, 0x27, 0x24, 0x29, 0x27, 0x56, 0x27, 0x4f, 0x00, 0x00, 0xff,
    0x1c, MP_QSTR_debug & 0xff, MP_QSTR_debug >> 8,
    0x37, 0x07, 0x80, 
    0x1c, MP_QSTR_print & 0xff, MP_QSTR_print >> 8,
    0xb0, 
